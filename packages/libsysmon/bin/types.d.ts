 ...
 */
export type UnavailableReason = 'unsupported-platform' | 'permission-denied' | 'not-found' | 'parse-error' | 'not-applicable';
...
export declare function unavailable(reason: UnavailableReason, detail?: string): Unavailable;
export declare function isAvailable<T>(probe: Probe<T>): probe is {
    available: true;
} & T;
