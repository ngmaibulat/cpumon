...
features:
  ...
  - title: Or a full-screen dashboard
    details: npx cpumon-tui draws per-core graphs, a memory breakdown, network throughput and a sortable, filterable process table. A separate package, so the library stays small.
---
